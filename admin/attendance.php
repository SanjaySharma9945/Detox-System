                    ...
                    <div class='widget-content nopadding'> 
                        <table class='table table-bordered table-hover'>
                            ...
                            <tbody> 
                                ...
                                $current_date = date('Y-m-d'); // Only date part, not time
                                ...
                                while($row = mysqli_fetch_array($result)){ 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php
                                            // Ensure $row['user_id'] is set before using it
                                            if(isset($row['user_id'])) {
                                                ...
                                                if($row_exist){
                                                    ...
                                                    <div class='text-center'>
                                                        <span class="label label-inverse"><?php echo $row_exist['curr_date'] . ' ' . $row_exist['curr_time'];?></span>
                                                    </div>
                                                    <div class='text-center'>
                                                ...
                                                echo "User ID not found"; // Optional error handling
                                            }
                                            ?>
                                        </td>
                                    </tr>
...
<!--Footer-part-->
<div class="row-fluid">
    <div id="footer" class="span12"> <?php echo date("Y");?> &copy; Detox Fitness. All rights reserved.</a> </div>
</div>
